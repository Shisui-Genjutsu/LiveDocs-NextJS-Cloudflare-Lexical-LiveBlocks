...
// Conditionally import Sentry only if not disabled
const isSentryEnabled = process.env.NEXT_PUBLIC_DISABLE_SENTRY !== 'true';
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://bhaskar-pt.sentry.io/issues/?project=4509751832281168">Issues Page</a>.
